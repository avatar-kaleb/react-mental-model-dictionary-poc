...
This project was a proof of concept to move my Polymer project into React. I have archived for viewing but created a private repo for my own code base.

---

My first project using Create React App V2 (table of contents at the end of readme). This project is a redo of my polymer 2 mental model dictionary, keeping me up to date on new libraries in my free time! Secondly, I wanted to acknowledge the help I was given from this for react/hocs and firebase [guide](https://www.robinwieruch.de/complete-firebase-authentication-react-tutorial/#react-router-setup).

If you want to fork and create your own mental model dictionary, please note that the security rules uploaded in the repo are unsafe - I use my own copies locally. Thank you!

Let me know what you think and if you have any code improvement suggestions!
...
- [Update](#update)
  ...
  - [Changing the Page &lt;title&gt;](#changing-the-page-lttitlegt)
  ...
  - [Proxying API Requests in Development](#proxying-api-requests-in-development)
    - [&quot;Invalid Host Header&quot; Errors After Configuring Proxy](#quotinvalid-host-headerquot-errors-after-configuring-proxy)
    - [Configuring the Proxy Manually](#configuring-the-proxy-manually)
  - [Using HTTPS in Development](#using-https-in-development)
      - [Windows (cmd.exe)](#windows-cmdexe-1)
      - [Windows (Powershell)](#windows-powershell-1)
      - [Linux, macOS (Bash)](#linux-macos-bash-1)
  - [Generating Dynamic &lt;meta&gt; Tags on the Server](#generating-dynamic-ltmetagt-tags-on-the-server)
  ...
  - [Deployment](#deployment)
    ...
    - [GitHub Pages](#github-pages)
      ...
      - [Troubleshooting](#troubleshooting)
        - [&quot;/dev/tty: No such a device or address&quot;](#quotdevtty-no-such-a-device-or-addressquot)
        - [&quot;Cannot read property 'email' of null&quot;](#quotcannot-read-property-email-of-nullquot)
    - [Heroku](#heroku)
      - [Resolving Heroku Deployment Errors](#resolving-heroku-deployment-errors)
        - [&quot;Module not found: Error: Cannot resolve 'file' or 'directory'&quot;](#quotmodule-not-found-error-cannot-resolve-file-or-directoryquot)
        - [&quot;Could not find a required file.&quot;](#quotcould-not-find-a-required-filequot)
    - [Netlify](#netlify)
    - [Now](#now)
